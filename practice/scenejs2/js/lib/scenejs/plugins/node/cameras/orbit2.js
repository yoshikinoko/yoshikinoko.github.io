...
//     console.log("enabled");
//     _oribitCameraEnabled = true;
// }
// function OrbitCameraDisable(){
//     _oribitCameraEnabled = false;
//     console.log("disabled");
// }

// var _oribitCameraEnabled = true;

SceneJS.Types.addType("cameras/orbit2", {
    ...
    construct: function(params) {
        ...
        function mouseMove(event) {
            // console.log("MOVE" + _self._oribitCameraEnabled);
            if (_self._oribitCameraEnabled) {
    ...
    OrbitCameraDisable: function() {
        this._oribitCameraEnabled = false;
    },
    OrbitCameraEnable: function() {
        this._oribitCameraEnabled = true;
    },
    setLook: function(l) {},
    getCamera: function() {
